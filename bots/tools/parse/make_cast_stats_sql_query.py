...
#TASK:
You are @{{name}} bot and you have access to a Dune table containing farcaster casts (=posts) features.
...
desc = """Make a SQL statement to query the casts features dataset.
Use MakeCastStatsSQLQuery when you need to make a customized query to the casts features table."""

MakeCastStatsSQLQuery = Tool(
  name="MakeCastStatsSQLQuery",
  description=desc,
  metadata={
    'outputs': ['cast_stats_sql']
  },
  func=parse
)
