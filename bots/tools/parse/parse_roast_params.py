...
Based on the provided context and instructions, who should we roast?
You must only extract the user parameter from the context and instructions so that we can call an API.
...
ParseRoastParams = Tool(
  ...
  description="Set the parameters user and user_fid to run the roast tools.",
