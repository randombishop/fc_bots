...
In this article, I describe my journey building AI agents on the [Farcaster](https://warpcast.com/) social network.

Disclaimer: I am not an expert in AI agents (yet), I am just sharing my learnings as I go along.

Target audience: 
* Devs and tech enthusiasts interested in AI agents.
...
My current framework, which looks like this, is pretty reliable with its set of about 50 tools. 
