...
<img src="./article_img/splash2.png" width="400">
...
It was designed to build social media AI agents for the Farcaster network, but the learnings are generalizable to many other use cases. 
We are actually using a very similar approach at a startup that I work with, building AI for propery management ([hiresuper](https://www.hiresuper.com/).)
Please DM me `@randombishop` on Farcaster or Twitter if you are interested in social media or property management AI assistants.
